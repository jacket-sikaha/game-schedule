/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5636b1d7a2ccdac9e3a79eefe45adc81)
...
interface __BaseEnv_Env {
	...
	VITE_FGO_PROXY_API: "https://cron.sikaha.dpdns.org/api/fgo";
	...
	VITE_BA_API: "https://bluearchive-cn.com/api/news/list?pageIndex=1&pageNum=16&type=1";
	VITE_BA_JP_API: "https://www.gamekee.com/v1/activity/page-list?importance=0&sort=-1&keyword=&limit=999&page_no=1&serverId=15&status=0";
	...
	VITE_ZZZ_API: "https://announcement-api.mihoyo.com/common/nap_cn/announcement/api/getAnnList?game=nap&game_biz=nap_cn&lang=zh-cn&bundle_id=nap_cn&channel_id=1&level=60&platform=pc&region=prod_gf_cn&uid=10000000";
