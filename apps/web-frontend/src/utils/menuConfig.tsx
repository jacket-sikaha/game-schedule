...
export const menuList: menuItem[] = [
  ...
  },
  {
    name: 'NIKKE:胜利女神（外服）',
    path: '/nikke',
    icon: 'https://static.wikia.nocookie.net/nikke-goddess-of-victory-international/images/9/98/Cinderella_%28Beautiful_Me%29_MI.png/revision/latest?cb=20250424000257',
    element: <Nikke />
  },
  {
    name: '尘白禁区',
